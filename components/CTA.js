...
export default function CTA({title, subtitle, primaryHref = '/', secondaryHref = '/resources'}){
  return (
    <section className="bg-gradient-to-r from-teal-600 to-blue-700 text-white rounded-lg p-8 shadow-md">
      <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Link href={primaryHref} className="bg-white text-teal-700 px-4 py-2 rounded font-semibold">Join Community</Link>
